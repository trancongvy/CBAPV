...
namespace QLSX
{
    public partial class fLichSX : XtraForm
    {
        ...
        {
            LSXappoint apt = new LSXappoint(schedu,dr);
            return apt;
        }
        ...
        private void Storage_AppointmentChanging(object sender, PersistentObjectCancelEventArgs e)
        {
            ...
            if (apt != null)
            {
                if (apt.TuNgayKH<= DateTime.Now || (e.Object as Appointment).Start <= DateTime.Now)
                {
                    e.Cancel = true;
                }
        ...
        private void Schedu_EditAppointmentFormShowing(object sender, AppointmentFormEventArgs e)
        {
            ...
            if (apt != null) {
                fAppoint fA = new fAppoint(schedu,apt);
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            fAppoint Af = new fAppoint(schedu,apt);
